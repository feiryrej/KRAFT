...
export const applicantRouter = Router()
    .get('/getApplicants', async(req:Request, res: Response) => {
        ...
        res.json({ message: 'Applicants retrieved successfully', applicants: applicants }).status(StatusCodes.OK);
    })
    .get('/getApplicant/:id', async(req: Request, res: Response) => {
        ...
        res.json({message: 'Applicant retrieved successfully', applicant: applicant}).status(StatusCodes.OK)
    })
    .post(
    '/createApplicant',
    ...
    .put('/updateApplicant/:id', validateData(UpdateApplicantModel), async(req: Request, res: Response) => {
        res.json({ message: 'Applicant updated successfully', applicant: req.body}).status(StatusCodes.OK);
    })
